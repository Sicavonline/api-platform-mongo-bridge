 ...
 */
final class FilterEagerLoadingExtension implements ContextAwareAggregationCollectionExtensionInterface
{
     ...
     * @return Builder
     */
    private function getQueryBuilderWithNewAliases(Builder $queryBuilder, QueryNameGeneratorInterface $queryNameGenerator, string $originAlias = 'o', string $replacement = 'o_2')
    {
        $queryBuilderClone = clone $queryBuilder;

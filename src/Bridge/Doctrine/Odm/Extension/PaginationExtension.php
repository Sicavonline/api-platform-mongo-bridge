...
class PaginationExtension implements ContextAwareQueryResultCollectionExtensionInterface
{
    ...
    /** @var bool configuration api-plateform, la pagination peut etre desactiv� via les configurations */
    private $enabled;
    ...
    /** @var bool configuration api-plateform, est ce que la pagination est partiel ? si oui pas de count de requ�te */
    private $partial;
    /** @var bool configuration api-plateform, est ce que la pagination est partiel pour le client ? si oui pas de count de requ�te */
    ...
    /**
     * Construction du PaginatorExtension, ce paginator � des d�pendances sur beaucoup de param�tre api platform.
     *
    ...
    /**
     * Est ce que la pagination est activ� dans les configuration.
     *
